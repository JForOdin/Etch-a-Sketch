/// erase board sets each pixel back to neutral lightgrey color 
const eraseBoard = () => {
...
/// Below are three functions that create varying board sizes
...
/////////////
/// Paint function determines the current state of the mouse click
/// if paintOn is false dont change pixel color
const paint = () => {
    if(paintOn)
        paintOn=false;
    else
...
{   
    ...
    /// for the number of tiles in X and Y create a new div element
...
boardDiv.appendChild(rowDiv); //add our row div to our static html board div
